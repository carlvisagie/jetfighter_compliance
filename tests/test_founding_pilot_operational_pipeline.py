"""Founding Pilot operational review pipeline — queue, classification, actions, COTE."""
...
def test_queue_generation_and_sort(fb_env, anon_client, client):
    ...
    anon_client.post(
        ...
        data={"email": "b@co.com", "company": "Pilot"},
    )
...
def test_telemetry_emitted_on_upload(monkeypatch, fb_env, anon_client):
    ...
    assert "intake_received" in types or "pilot_upload_completed" in types
