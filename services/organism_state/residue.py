"""Legacy compatibility shim — preserves scan_repo_for_pilot_residue signature."""
...
def scan_repo_for_pilot_residue(repo_root: Path) -> Dict[str, Any]:
    """Scan ``repo_root`` for founding_pilot residue (legacy dict shape)."""
    ...
    return {
        "pilot_residue_detected": report.detected,
        ...
        "pilot_routes_remaining": routes[:10],
        "pilot_imports_remaining": imports[:10],
        "pilot_files_remaining": total,
    }
