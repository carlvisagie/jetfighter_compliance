...
ENGINE_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "acquisition_scoring": {
        ...
        "writes": ["data/acquisition/queue/ (scores only)"],
        "read_before": True,
        "write_after": False,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
        "fix_needed": "Emit learning signal on score band changes (optional)",
    },
    ...
    "emails": {
        ...
        "reads": [],
        "writes": ["SMTP only (no durable truth)"],
        "read_before": False,
        "write_after": False,
        "orphan_risk": "none",
        "duplicate_truth_risk": "none",
    ...
    "reports_export": {
        ...
        "classification": "outside",
        "reads": ["projects/", "forensics"],
        "writes": ["export bundles", "MD reports"],
        "read_before": False,
        "write_after": False,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
        "fix_needed": "Read-only; should read central memory for context (future)",
    },
    "stripe_webhook": {
