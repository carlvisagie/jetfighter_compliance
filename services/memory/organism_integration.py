...
ENGINE_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "acquisition_forensics": {
        ...
        "writes": ["forensic_events.jsonl", "org_profiles.jsonl", "telemetry", "central memory via bridge"],
        "read_before": False,
        "write_after": True,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
    ...
    "acquisition_memory_island": {
        ...
        "reads": ["learning_state.json (acquisition_weights)", "outcomes.jsonl"],
        "writes": ["learning_state.json (acquisition_weights)", "outcomes.jsonl", "weights.json (mirror)"],
        "read_before": True,
        "write_after": True,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
    ...
    "workflow": {
        ...
        "writes": ["data/process/{project}.json", "telemetry", "timeline"],
        "read_before": False,
        "write_after": True,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
    ...
    "coc_ledger": {
        ...
        "classification": "plugged",
        "reads": ["ledger.log"],
        "writes": ["data/ledger/ledger.log", "telemetry", "timeline"],
        "read_before": False,
        "write_after": True,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
    ...
    "rfq": {
        ...
        "classification": "plugged",
        "reads": ["data/rfq/*.json"],
        "writes": ["data/rfq/", "ledger events", "telemetry", "organism bridges"],
        "read_before": False,
        "write_after": True,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
    ...
    "job_engine": {
        ...
        "classification": "plugged",
        "reads": ["data/jobs/"],
        "writes": ["projects/", "ledger", "emails", "telemetry"],
        "read_before": False,
        "write_after": True,
        "orphan_risk": "low",
        "duplicate_truth_risk": "low",
    ...
    "organism_sqlite": {
        ...
        "orphan_risk": "none",
        "duplicate_truth_risk": "none",
        "fix_needed": "DELETED - legacy code removed 2026-06-13",
    },
    "ui_ops": {
